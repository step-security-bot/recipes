...
class CookDocs:
	...
	def download(self) -> None:
		testdebug = subprocess.run(["go", "install", "github.com/nicholaswilde/cook-docs/cmd/cook-docs@latest"], stdout=subprocess.PIPE, stderr=subprocess.PIPE, check=True, text=True)
		print(testdebug)
